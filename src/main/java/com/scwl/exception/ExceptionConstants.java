...
public class ExceptionConstants {
    ...
    public static final String SERVICE_SYSTEM_ERROR_MSG = "未知异常,请联系工程师";
    ...
    //商品
    public static final int STORE_ERROR_CODE = 0000004;
    public static final String STORE_ERROR_MSG = "只能新增系统店铺的单据,您还没有系统店铺，请先去添加";


    //商品
    public static final int Orders_ERROR_CODE = 0000005;
    public static final String Orders_ERROR_MSG = "订单商品未对应，拉取失败!";
    /**
